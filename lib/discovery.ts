...
export const semanticGroups: Record<string, string[]> = {
  ...
  商科竞赛: ["商业案例", "案例大赛", "商赛", "case", "咨询", "商业分析", "市场调研", "市场调查", "供应链", "物流设计", "财务分析", "CPA", "财管"],
  创新项目: ["挑战杯", "创新创业", "互联网+", "创业项目", "项目运营", "产品设计", "商业策划", "路演", "创青春"],
  技术竞赛: ["数学建模", "建模", "ACM", "算法", "刷题", "编程", "代码", "leetcode", "github", "人工智能", "AI", "大数据", "数据科学", "机器人", "电子设计", "嵌入式", "自动化", "硬件", "智能汽车", "工程实践"],
  创意竞赛: ["创意设计", "UI设计", "工业设计", "视觉设计", "广告艺术", "文案", "海报", "短视频", "摄影", "视频创作"],
  语言表达: ["英语", "外语", "翻译", "英语词汇", "英语口语", "演讲", "辩论", "主持", "跨文化", "国才杯"],
  科研协作: ["科研", "论文", "科研项目", "文献", "实验", "学术", "力学", "物理", "化学", "健康生命", "医学", "节能减排", "环保公益", "社会调研"],
